...
import { DESCOPE_AUTHENTICATED_FLOW_ID } from '@env'
...
export default function AuthenticatedFlowScreen({ onBack }: Props) {
  const sdk = useDescope()
  const { manageSession, updateUser } = useSession()
  const flowUrl = useHostedFlowUrl(DESCOPE_AUTHENTICATED_FLOW_ID)
  ...
  return (
    <View style={styles.container}>
      <View style={styles.flowContainer}>
        ...
        {done && <Text style={styles.done}>Flow completed</Text>}
      </View>
