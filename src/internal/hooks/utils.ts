const generateErrorMsg = (entryType: string) => `You can only use this ${entryType} after sdk initialization. Make sure to provide a 'projectId' to the <AuthProvider /> component`
